...
7. Exact civil-calendar arithmetic: `python -m aktreader date-convert 1900-02-29 --from-calendar julian` must return Gregorian `1900-03-13`. The command requires no locale, model, scan, or network access.
